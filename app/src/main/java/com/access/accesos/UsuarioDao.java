...
public class UsuarioDao {
    ...
    private Usuario crearUsuario(Cursor cursor){
        Usuario usuario = new Usuario(
                ...
                cursor.getInt(cursor.getColumnIndex(DBHelper.Usuarios.IDROL))
        );
        return usuario;
    }
    ...
    public List<Rol> listarRoles(){
        Cursor cursor = getDatabase().query("roles",DBHelper.Roles.COLUMNASR,null, null, null, null,null);
    ...
    public long modificarUsuario(Usuario usuario){
        ...
        values.put(DBHelper.Usuarios.IDROL, usuario.getIdrol());
